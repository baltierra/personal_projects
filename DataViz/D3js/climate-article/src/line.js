const height_3 = 600,
width_3 = 900,
margin_3 = ({ top: 20, right: 85, bottom: 40, left: 70 });

const svg_3 = d3.select("#line")
    .append("svg")
    .attr("viewBox", [0, 0, width_3, height_3]);
...
d3.csv("./data/totalGHG.csv").then(data => {
    ...
    let x = d3.scaleLinear()
        ...
        .range([margin_3.left, width_3 - margin_3.right]);
    
    let y = d3.scaleLinear()
        .domain(d3.extent(data, d => d.Value))
        .range([height_3 - margin_3.bottom, margin_3.top]);
    ...
    svg_3.append("g")
        .attr("transform", `translate(0,${height_3 - margin_3.top})`)
