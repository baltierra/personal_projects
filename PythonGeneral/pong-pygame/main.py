...
#DECLARACIÓN DE CLASE PARA PROGRAMAR LAS RAQUETAS
class Pad(pygame.sprite.Sprite):
    def __init__(self, pos=(0, 0)):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.Surface((12, 30)).convert()
        self.image.fill((230, 140, 150))
...
#DECLARACIÓN DE CLASE PARA PROGRAMAR LA PELOTA
...
#DECLARACIÓN DE CLASE PARA PROGRAMAR EL MARCADOR
class Score(pygame.sprite.Sprite):
    def __init__(self, font, pos=(0, 0)):
        ...
        self.pos = pos
        self.score = 0
        self.image = self.font.render(str(self.score), 0, (234, 10, 180))
        self.rect = self.image.get_rect(center=self.pos)
...
def main():
    ...
    pygame.display.set_caption('Pong - Programación UdeC')
    ...
    # BLOQUE PARA MANEJAR EL MARCADOR EN PANTALLA
    if not pygame.font:
    ...
    while 1:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                ball.start(randint(-3, 3), randint(-3, 3))
